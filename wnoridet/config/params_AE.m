function constants = params_AE()
% Training parameters for white noise orientation discrimination experiment

constants.subject = 'AE';                   % first/last
constants.fixationRadius = 0.75;            % in degrees
constants.stimulusLocation = 3.5 * [1; 1];  % in degrees
constants.spatialFreq = 2;                  % in cycles/degree
constants.diskSize = 4;                     % in degrees
...
constants.diskSize = constants.diskSize * pxPerDeg;
